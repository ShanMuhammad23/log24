  ...
  return (
    <View className="mb-3 w-[48.5%] rounded-2xl border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900">
      ...
      <View className="mt-2 flex-row items-end justify-between">
        <Text className="text-2xl font-semibold text-slate-900 dark:text-slate-100">{toHours(currentMinutes)}</Text>
        <Text className="mb-0.5 text-base font-medium text-slate-500 dark:text-slate-400">/ {toHours(targetMinutes)}</Text>
      </View>
...
export default function RequirementsScreen() {
  ...
  return (
    <SafeAreaView edges={['top']} className="flex-1 bg-slate-50 dark:bg-slate-950">
      <ScrollView className="flex-1" contentContainerStyle={{ paddingHorizontal: 14, paddingTop: 10, paddingBottom: 28 }}>
        <Text className="mb-3 text-center text-3xl font-bold text-slate-900 dark:text-slate-100">Requirements</Text>
        ...
        {loading ? (
          ...
          <>
            ...
            <View className="mb-3 flex-row items-center justify-between">
              <Text className="text-2xl font-semibold text-slate-900 dark:text-slate-100">CPL Requirements</Text>
            ...
            <View className="mb-3 rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
              ...
              <View className="mt-2 flex-row items-end justify-center">
                <Text className="text-3xl font-bold text-blue-700 dark:text-blue-300">{toHours(totals.total)}</Text>
                <Text className="mb-0.5 ml-2 text-base font-medium text-slate-500 dark:text-slate-400">/ {toHours(200 * 60)}</Text>
              </View>
